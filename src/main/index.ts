...
// another tool-style "Initialize a Repository" (Local Only): create <location>/<name>,
...
// another tool-style init on GitHub.com: create the remote repo, optionally clone
...
// used by the another tool-style Clone modal.
