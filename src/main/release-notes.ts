...
- **Clic droit sur une branche = sur son commit-tip** : le même menu complet (merge/rebase/renommer/supprimer… + les actions du commit), comme another tool. Un commit qui ne porte pas de branche garde son menu de commit.
