...
const gitAPI = {
  ...
  pullBranch: (branch: string) => invoke('git:pull-branch', branch),
  ...
  // Worktrees
  listWorktrees: (opts?: { facts?: boolean }) => invoke('git:list-worktrees', opts),
  ...
  openTerminal: (at?: string) => invoke('app:open-terminal', at),
  revealInFileManager: (at: string) => invoke('app:reveal-in-file-manager', at),
