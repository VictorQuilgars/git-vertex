...
const fr = {
  ...
  'graph.menu.resetSoft': '⏪ Réinitialiser la branche courante ici (soft) — garde les changements indexés',
  'graph.menu.resetMixed': '⏪ Réinitialiser la branche courante ici (mixed) — garde les changements non-indexés',
  'graph.menu.resetHard': '⏪ Réinitialiser la branche courante ici (hard) — supprime tous les changements',
