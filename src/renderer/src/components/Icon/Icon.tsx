...
const PAINT: Record<string, (C: Ink) => JSX.Element> = {
  ...
  history: (C: Ink) => <><path d="M7 3h6.5L18 7.5V21H7z"/><circle cx="11.5" cy="13.5" r="3.4"/><path d="M11.5 11.8v1.9l1.4.9"/></>,
  ...
  merge: (C: Ink) => <><path d="M7 4l5 12M17 4l-5 12v4"/><circle cx="7" cy="4" r="1.9"/><circle cx="17" cy="4" r="1.9"/><circle cx="12" cy="17" r="1.9" fill="currentColor" stroke="none"/></>,
  ...
  rebase: (C: Ink) => <><path d="M4 19h16"/><circle cx="7" cy="19" r="1.9"/><circle cx="13" cy="19" r="1.9"/><path d="M7 15c2-6 8-6 10 0M17 11.5V15h-3.5"/></>,
  reflog: (C: Ink) => <><path d="M6 6.2A7.6 7.6 0 1 1 4.4 12"/><path d="M6.5 2.8v3.6H2.9"/><circle cx="12" cy="12" r="1.9"/></>,
  repo: (C: Ink) => <><path d="M6.5 3H19v18H6.5A2.5 2.5 0 0 1 4 18.5v-13A2.5 2.5 0 0 1 6.5 3z"/><path d="M4 16.5A2.5 2.5 0 0 1 6.5 14H19"/></>,
  staging: (C: Ink) => <><path d="M5 13v5.5h14V13"/><path d="M12 3.5V12M8.8 6.7L12 3.5l3.2 3.2"/></>,
  stash: (C: Ink) => <><rect x="4.5" y="12" width="15" height="7" rx="1.5"/><path d="M10 15.5h4M12 3v5.5M9.8 6.3L12 8.5l2.2-2.2"/></>,
