...
export const KEY_SYNTAX: Record<string, { label: string; syntax: string }> = {
  ...
  mentions: { label: 'Mentioned', syntax: 'mentions:user_name' },
  'review-requested': { label: 'Requested Reviewers', syntax: 'review-requested:user_name' },
  'reviewed-by': { label: 'Reviewed By', syntax: 'reviewed-by:user_name' },
  base: { label: 'Base', syntax: 'base:branch_name' },
  head: { label: 'Head', syntax: 'head:branch_name' },
  ...
  status: { label: 'Status', syntax: 'status:success or status:pending or status:failure' },
