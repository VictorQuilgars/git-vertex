...
// GitKraken-style toolbar cell: label on top, icon below.
...
export default function Toolbar({
  ...
  onUndo, onFetch, onPush, onPull, onCreateBranch,
  ...
  return (
    <div className="toolbar">
      ...
      {/* Centered main action group (GitKraken layout) */}
      <div className="tb-group">
        ...
        />
        <TBtn label="Redo" title={t('toolbar.redo.tooltip')} disabled onClick={() => {}}
