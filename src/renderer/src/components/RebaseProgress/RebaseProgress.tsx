...
// editor tab (another tool-style). Auto-opened by the VS Code extension whenever a
...
// fixup/drop + reorder — same as another tool' paused-rebase view), the conflicted
...
export default function RebaseProgress() {
  ...
  const renderReadOnlyStep = (s: RebaseStep, key: string, status: 'done' | 'current') => {
    ...
    // neutral "current" blue — same convention as another tool' rebase view.
