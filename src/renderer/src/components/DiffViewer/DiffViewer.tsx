...
export default function DiffViewer({ commit, diff, files, loading, headerLabel }: DiffViewerProps) {
  ...
  if (!commit && !headerLabel) {
    return (
      <div className="diff-empty">
        <svg width="48" height="48" viewBox="0 0 16 16" fill="var(--text-disabled)">
          <path d="M11.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5zm-2.25.75a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.492 2.492 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25zM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5zM3.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"/>
        </svg>
        <p>{t('dv.selectCommit')}</p>
      </div>
    )
  }
  ...
  return (
    <div className="diff-viewer">
      {/* Commit header (or comparison label) */}
      <div className="commit-header">
        {commit ? (
          <>
            <div className="commit-hash-badge" style={{ background: 'color-mix(in srgb, var(--accent-emphasis) var(--alpha-subtle), transparent)', borderColor: 'color-mix(in srgb, var(--accent-emphasis) var(--alpha-visible), transparent)' }}>
          ...
          <div className="commit-meta">
            <div className="commit-title">{headerLabel}</div>
          </div>
        )}
        {/* View mode toggle */}
