# Prompt pour Claude CLI — Git GUI
...
C'est un client Git graphique de bureau. Voici les règles impératives :
...
Colore chaque bloc de lignes du même commit avec une couleur dérivée du hash (comme dans VSCode another tool).
