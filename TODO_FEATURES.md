...
### Graphe & Navigation
- **Graphe de commits moderne** : Lignes courbées, couleurs distinctes par branche, commits ancêtres partagés sur la bonne couleur.
- **Ordre chronologique des commits** : `--date-order` pour un affichage temporel fidèle.
...
- **Layout colonnes** : BRANCH/TAG | GRAPH | MESSAGE | AUTHOR | DATE | SHA avec redimensionnement.
