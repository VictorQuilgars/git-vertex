...
// Tokens, not literals — these end up in inline styles, and app.tsx has already
// pulled in App.css (and tokens.css) by the time this renders. `reword` and
            ...
            {entry.kind === 'commit' ? (
              <>
                <select
                  ...
                  style={{ color: ACTION_COLORS[entry.action] ?? 'var(--text-primary)' }}
                >
                  {ACTIONS.map(a => (
