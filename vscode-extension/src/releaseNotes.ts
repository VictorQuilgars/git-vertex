...
### 📈 A minimap over the graph
- The loaded history as a strip, **day by day**: HEAD and its upstream, the branches, the stretch on screen, the days a search matched. **Click** a day to go to its commit, **drag** to zoom. The switch in the toolbar hides it.
...
- **The ready-made fragments wait behind a Templates button** at the right of each field — a pick writes the fragment in; one already in the text reads as taken.
...
- The panel **had no refresh loop of any kind** and now has the same one.
